...
public class CadastroPJController {
	...
	private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorCpf(cadastroPJDto.getCpf())
				.ifPresent(func -> result.addAllErrors((Errors) new ObjectError("funcionario", "CPF já existente")));

		this.funcionarioService.buscarPorEmail(cadastroPJDto.getEmail())
				.ifPresent(func -> result.addAllErrors((Errors) new ObjectError("funcionario", "Email já existente")));
	}
	...
	private Funcionario converterDtoParaFuncionario(CadastroPJDto cadastroPJDto, BindingResult result)
		...
		funcionario.setNome(PasswordUtils.gerarBCrypt(cadastroPJDto.getSenha()));
